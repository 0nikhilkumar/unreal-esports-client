...
const UserProfile = () => {
  const [teamMembers, setTeamMembers] = useState([
    ...
    { id: 3, name: 'PlayerThree', ign: 'player3IGN', igid: 'player3IGID', email: 'player3@example.com', isEditing: false },
    { id: 4, name: 'PlayerFour', ign: 'player4IGN', igid: 'player4IGID', email: 'player4@example.com', isEditing: false },
    { id: 5, name: 'PlayerFive', ign: 'player5IGN', igid: 'player5IGID', email: 'player5@example.com', isEditing: false },
  ]);
      ...
      <div className="relative h-[40vh] bg-[url('/images/esports-banner.jpg')] bg-cover bg-center">
        ...
        <div className="absolute bottom-0 left-0 right-0 px-6 py-8 max-w-7xl mx-auto">
          <div className="flex items-end space-x-8">
            ...
            <div>
              <h1 className="text-5xl font-bold tracking-tight mb-2">PlayerName123</h1>
              <p className="text-xl text-indigo-300 mb-4">Professional Valorant Player | Team Captain</p>
