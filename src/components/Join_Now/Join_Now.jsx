  ...
  return (
    <div>
      ...
      <div className="text-center pt-10 bg-black">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold uppercase relative inline-block text-white">
          Get A Experience
      ...
      <div className="w-full px-6 flex flex-col-reverse lg:flex-row justify-center items-center bg-gradient-to-b from-black to-black h-auto py-10">
        ...
        <div className="w-full lg:w-1/2 flex justify-center items-center p-6">
          <div className="bg-gray-900 text-white p-6 sm:p-10 rounded shadow-md max-w-md mx-auto lg:mx-0">
            <p className="text-blue-600 font-oswald font-medium text-lg uppercase mb-4 text-center lg:text-left">
              Get all team members
            </p>
            <h2 className="font-oswald text-xl sm:text-2xl uppercase leading-snug mb-4 text-center lg:text-left">
              Experience just for gamers{" "}
              <strong className="text-blue-600">offer</strong>
            </h2>
            <p className="text-gray-400 text-sm sm:text-base leading-relaxed mb-5 text-justify">
            ...
            <p className="text-gray-400 text-sm sm:text-base flex items-center gap-2">
              <MdOutlineDoubleArrow className="text-blue-600 text-xl" />
        ...
        <div className="w-full lg:w-1/2 px-6 flex flex-col justify-center items-center text-center lg:text-left my-10">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
            ...
            <span className="block text-sm sm:text-base tracking-wide mt-2 text-white text-center">
              Step into the arena and conquer your fears
            </span>
          </h1>
          <Link
            to="/signup"
            className=" overflow-hidden relative inline-flex items-center justify-center px-8 sm:px-10 py-3 sm:py-4 font-mono font-medium tracking-tighter text-white bg-blue-600 rounded-lg group">
